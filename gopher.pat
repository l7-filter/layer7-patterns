# Gopher - A precurser to HTTP (RFC 1436)
...
# else), then a dot and at least two letters (see dns.pat), a tab and then a 
# number which could be the start of a port number.
